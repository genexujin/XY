...
Insert into OA.NOTIFICATIONS (ID,CATEGORY,PRIORITY,TITLE,CONTENT,TO_ROLE_ID,EVENT_DATE,IS_SMS_SENT,STATE) values ('1','test',1,'您有新的车辆审核','需要你审核以下车辆申请','1',to_date('07-FEB-13','DD-MON-RR'),'N','UNREAD');
