...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "OA"."PS_TXN_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 50 START WITH 5801 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
Insert into OA.CLASSROOM_CALENDAR (ID,ACT_TITLE,ACT_START_TIME,ACT_END_TIME,USER_ID,USER_DISPLAY_NAME,NUM_OF_PEOPLE,CLASSROOM,COMMENTS,CREATED_AT,BATCH_ID,BATCH_NO,LOCATION_ID,LOCATION_NAME,CLASSROOM_ID,ALL_DAY) values ('306','asdfsadf',to_timestamp('28-JAN-13 12.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'),to_timestamp('28-JAN-13 11.59.59.000000000 PM','DD-MON-RR HH.MI.SS.FF AM'),'gene','徐晋',12,'教室101','asdf',to_date('27-JAN-13','DD-MON-RR'),null,'CLSRM-BATCH-00008','LOC-1','丽园','1','ALLDAY');
...
Insert into OA.CONF_ROOM_CALENDAR (ID,USER_ID,USER_DISPLAY_NAME,LOCATION_ID,LOCATION_NAME,MEETING_ROOM,MEETING_ROOM_ID,TITLE,PARTICIPANTS,START_TIME,END_TIME,COMMENTS,NEED_PROJECTOR,NEED_LOUDSPEAKER,NEED_BEVERAGE,NEED_FRUITS,NEED_SNACKS,SNACK_LEVEL,NUM_OF_PEOPLE,STATE,PR_ID,ALLDAY) values ('2','1','徐晋','LOC-1','丽园','2001','22','hhhhhhhhhhhhhh','hhhhhhhhhhhhhh',to_timestamp('29-JAN-13 07.30.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'),to_timestamp('29-JAN-13 09.30.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'),null,'N','N','N','N','Y','10',10,'已审核',null,'TIME');
Insert into OA.CONF_ROOM_CALENDAR (ID,USER_ID,USER_DISPLAY_NAME,LOCATION_ID,LOCATION_NAME,MEETING_ROOM,MEETING_ROOM_ID,TITLE,PARTICIPANTS,START_TIME,END_TIME,COMMENTS,NEED_PROJECTOR,NEED_LOUDSPEAKER,NEED_BEVERAGE,NEED_FRUITS,NEED_SNACKS,SNACK_LEVEL,NUM_OF_PEOPLE,STATE,PR_ID,ALLDAY) values ('4','1','徐晋','LOC-1','丽园','2001','22','RRRRRRRRRRRRR','XXXXXXXXXXXXXXX',to_timestamp('27-JAN-13 12.30.00.000000000 PM','DD-MON-RR HH.MI.SS.FF AM'),to_timestamp('27-JAN-13 05.30.00.000000000 PM','DD-MON-RR HH.MI.SS.FF AM'),'DSF','N','N','N','N','N',null,10,'已拒绝',null,'TIME');
...
Insert into OA.CONF_ROOM_CALENDAR (ID,USER_ID,USER_DISPLAY_NAME,LOCATION_ID,LOCATION_NAME,MEETING_ROOM,MEETING_ROOM_ID,TITLE,PARTICIPANTS,START_TIME,END_TIME,COMMENTS,NEED_PROJECTOR,NEED_LOUDSPEAKER,NEED_BEVERAGE,NEED_FRUITS,NEED_SNACKS,SNACK_LEVEL,NUM_OF_PEOPLE,STATE,PR_ID,ALLDAY) values ('5','1','徐晋','LOC-1','丽园','2001','22','yyyyyyy','wwwwwwwwwww',to_timestamp('28-JAN-13 11.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'),to_timestamp('28-JAN-13 12.00.00.000000000 PM','DD-MON-RR HH.MI.SS.FF AM'),null,'N','N','N','Y','N',null,12,'已审核',null,'TIME');
...
Insert into OA.LOVS (ID,CODE,LOV_DESC,PARENT_CODE,VALUE,CREATED_AT,CREATED_BY,LAST_UPDATED_BY,LAST_UPDATED_AT,FLEX_COL1,FLEX_COL2,FLEX_COL3) values ('30','PoState',null,null,'未提交',null,null,null,null,'1',null,null);
Insert into OA.LOVS (ID,CODE,LOV_DESC,PARENT_CODE,VALUE,CREATED_AT,CREATED_BY,LAST_UPDATED_BY,LAST_UPDATED_AT,FLEX_COL1,FLEX_COL2,FLEX_COL3) values ('31','PoState',null,null,'待审核',null,null,null,null,'2',null,null);
Insert into OA.LOVS (ID,CODE,LOV_DESC,PARENT_CODE,VALUE,CREATED_AT,CREATED_BY,LAST_UPDATED_BY,LAST_UPDATED_AT,FLEX_COL1,FLEX_COL2,FLEX_COL3) values ('32','PoState',null,null,'待审批',null,null,null,null,'3',null,null);
Insert into OA.LOVS (ID,CODE,LOV_DESC,PARENT_CODE,VALUE,CREATED_AT,CREATED_BY,LAST_UPDATED_BY,LAST_UPDATED_AT,FLEX_COL1,FLEX_COL2,FLEX_COL3) values ('33','PoState',null,null,'执行中',null,null,null,null,'4',null,null);
Insert into OA.LOVS (ID,CODE,LOV_DESC,PARENT_CODE,VALUE,CREATED_AT,CREATED_BY,LAST_UPDATED_BY,LAST_UPDATED_AT,FLEX_COL1,FLEX_COL2,FLEX_COL3) values ('34','PoState',null,null,'已完成',null,null,null,null,'5',null,null);
Insert into OA.LOVS (ID,CODE,LOV_DESC,PARENT_CODE,VALUE,CREATED_AT,CREATED_BY,LAST_UPDATED_BY,LAST_UPDATED_AT,FLEX_COL1,FLEX_COL2,FLEX_COL3) values ('35','PoState',null,null,'已撤消',null,null,null,null,'6',null,null);
