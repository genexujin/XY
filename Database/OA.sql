...
Insert into OA.EMPLOYEES (USER_NAME,PASSWORD,FIRST_NAME,LAST_NAME,GENDER,MGR_ID,DEPT_ID,EMAIL,MOBILE,OFFICE_PHONE,HOME_PHONE,FAX,LOCATION_ID,HOME_ADDRESS,OFFICE_ADDRESS,LAST_UPDATED_BY,LAST_UPDATED_AT,CREATED_BY,CREATED_AT,TITLE,ID,MGR_NAME,DEPT_NAME,EXPIRED) values ('poReceiver','welcome1','收货','采购',null,'2',null,null,'123',null,null,null,null,null,null,null,null,null,to_date('08-FEB-13','DD-MON-RR'),'采购收货','11','总务主任',null,'N');
...
Insert into OA.MENUS (MENU_ID,MENU_NAME,MENU_TASKFLOW_URL,MENU_DESC,MENU_CATEGORY,PARENT_MENU_ID,MENU_MASTER_CATEGORY,MENU_ICON_URL,EXPIRED,SEQ) values ('SYS_PUR_RECEIVE','收货','/WEB-INF/flows/po/MyPoReceiver.xml#MyPoReceiver','收货','PUR',null,'SYS','/images/icons/package.png','false','4');
