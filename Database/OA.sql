...
--------------------------------------------------------
--  File created - Saturday-January-26-2013   
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "OA"."CLASSROOM_BATCH_RESERVATI_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence CLASSROOM_CALENDAR_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "OA"."CLASSROOM_CALENDAR_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 301 CACHE 20 NOORDER  NOCYCLE ;
   --------------------------------------------------------
--  DDL for Sequence CONF_ROOM_CALENDAR_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "OA"."CONF_ROOM_CALENDAR_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "OA"."LOVS_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "OA"."PS_TXN_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 50 START WITH 4751 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
Insert into OA.LOVS (ID,CODE,LOV_DESC,PARENT_CODE,VALUE,CREATED_AT,CREATED_BY,LAST_UPDATED_BY,LAST_UPDATED_AT,FLEX_COL1,FLEX_COL2,FLEX_COL3) values ('5','ClsRmBatchSeq','Class Room Batch Sequence',null,'7',null,null,'徐晋',null,null,null,null);
Insert into OA.LOVS (ID,CODE,LOV_DESC,PARENT_CODE,VALUE,CREATED_AT,CREATED_BY,LAST_UPDATED_BY,LAST_UPDATED_AT,FLEX_COL1,FLEX_COL2,FLEX_COL3) values ('20','ConfRm',null,null,'3001',null,null,null,null,null,'（50座）','2');
Insert into OA.LOVS (ID,CODE,LOV_DESC,PARENT_CODE,VALUE,CREATED_AT,CREATED_BY,LAST_UPDATED_BY,LAST_UPDATED_AT,FLEX_COL1,FLEX_COL2,FLEX_COL3) values ('21','ConfRm',null,null,'1001',null,null,null,null,null,'（20座）','1');
Insert into OA.LOVS (ID,CODE,LOV_DESC,PARENT_CODE,VALUE,CREATED_AT,CREATED_BY,LAST_UPDATED_BY,LAST_UPDATED_AT,FLEX_COL1,FLEX_COL2,FLEX_COL3) values ('22','ConfRm',null,null,'2001',null,null,null,null,null,'（20座）','1');
Insert into OA.LOVS (ID,CODE,LOV_DESC,PARENT_CODE,VALUE,CREATED_AT,CREATED_BY,LAST_UPDATED_BY,LAST_UPDATED_AT,FLEX_COL1,FLEX_COL2,FLEX_COL3) values ('23','ConfRm',null,null,'4001',null,null,null,null,null,'（100座）','2');
...
Insert into OA.HELPDESK_CALLS (CALLER_ID, CALLEE_ID, LOCATION_ID, LOCATION_DETAIL, CREATE_AT,CREATE_BY,LAST_UPDATED_BY,LAST_UPDATED_AT,STATE,CALL_RESULT,CALL_RESULT_DETAIL, CALL_EVAL,CALL_EVAL_DETAIL,REASON_LEVEL_1,REASON_LEVEL_2,REASON_LEVEL_3,REASON_DETAIL)
                       values ('3','4','1',null,null,null,null,null,null,null,null,null,null,'6','13',null,null);
Insert into OA.HELPDESK_CALLS (CALLER_ID, CALLEE_ID, LOCATION_ID, LOCATION_DETAIL, CREATE_AT,CREATE_BY,LAST_UPDATED_BY,LAST_UPDATED_AT,STATE,CALL_RESULT,CALL_RESULT_DETAIL, CALL_EVAL,CALL_EVAL_DETAIL,REASON_LEVEL_1,REASON_LEVEL_2,REASON_LEVEL_3,REASON_DETAIL)
                       values ('1','4','1',null,null,null,null,null,null,null,null,null,null,'6','14',null,null);
Insert into OA.HELPDESK_CALLS (CALLER_ID, CALLEE_ID, LOCATION_ID, LOCATION_DETAIL, CREATE_AT,CREATE_BY,LAST_UPDATED_BY,LAST_UPDATED_AT,STATE,CALL_RESULT,CALL_RESULT_DETAIL, CALL_EVAL,CALL_EVAL_DETAIL,REASON_LEVEL_1,REASON_LEVEL_2,REASON_LEVEL_3,REASON_DETAIL)
                       values ('2','4','2',null,null,null,null,null,null,null,null,null,null,'7','9',null,null);
commit;
