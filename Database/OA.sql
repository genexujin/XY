...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "OA"."CLASSROOM_CALENDAR_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 341 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
Insert into OA.CLASSROOM_CALENDAR (ID,ACT_TITLE,ACT_START_TIME,ACT_END_TIME,USER_ID,USER_DISPLAY_NAME,NUM_OF_PEOPLE,CLASSROOM,COMMENTS,CREATED_AT,BATCH_ID,BATCH_NO,LOCATION_ID,LOCATION_NAME,CLASSROOM_ID,ALL_DAY) values ('308','uuuuuuuuuuu',to_timestamp('30-JAN-13 09.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'),to_timestamp('30-JAN-13 12.30.00.000000000 PM','DD-MON-RR HH.MI.SS.FF AM'),'gene','徐晋',22,'教室101',null,to_date('29-JAN-13','DD-MON-RR'),null,null,'LOC-1','丽园','1','TIME');
...
Insert into OA.CONF_ROOM_CALENDAR (ID,USER_ID,USER_DISPLAY_NAME,LOCATION_ID,LOCATION_NAME,MEETING_ROOM,MEETING_ROOM_ID,TITLE,PARTICIPANTS,START_TIME,END_TIME,COMMENTS,NEED_PROJECTOR,NEED_LOUDSPEAKER,NEED_BEVERAGE,NEED_FRUITS,NEED_SNACKS,SNACK_LEVEL,NUM_OF_PEOPLE,STATE,PR_ID,ALLDAY) values ('21','1','徐晋','LOC-1','丽园','1001','21','fffffffffffffff','eeeeeeeeeeeeeeee',to_timestamp('06-FEB-13 12.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'),to_timestamp('06-FEB-13 12.00.00.000000000 PM','DD-MON-RR HH.MI.SS.FF AM'),'fff','Y','N','N','N','Y','10',22,'待审核',null,'TIME');
...
Insert into OA.LOVS (ID,CODE,LOV_DESC,PARENT_CODE,VALUE,CREATED_AT,CREATED_BY,LAST_UPDATED_BY,LAST_UPDATED_AT,FLEX_COL1,FLEX_COL2,FLEX_COL3) values ('32','PoState',null,null,'未提交',null,null,null,null,'1',null,null);
Insert into OA.LOVS (ID,CODE,LOV_DESC,PARENT_CODE,VALUE,CREATED_AT,CREATED_BY,LAST_UPDATED_BY,LAST_UPDATED_AT,FLEX_COL1,FLEX_COL2,FLEX_COL3) values ('33','PoState',null,null,'待审核',null,null,null,null,'2',null,null);
Insert into OA.LOVS (ID,CODE,LOV_DESC,PARENT_CODE,VALUE,CREATED_AT,CREATED_BY,LAST_UPDATED_BY,LAST_UPDATED_AT,FLEX_COL1,FLEX_COL2,FLEX_COL3) values ('34','PoState',null,null,'待审批',null,null,null,null,'3',null,null);
Insert into OA.LOVS (ID,CODE,LOV_DESC,PARENT_CODE,VALUE,CREATED_AT,CREATED_BY,LAST_UPDATED_BY,LAST_UPDATED_AT,FLEX_COL1,FLEX_COL2,FLEX_COL3) values ('35','PoState',null,null,'执行中',null,null,null,null,'4',null,null);
Insert into OA.LOVS (ID,CODE,LOV_DESC,PARENT_CODE,VALUE,CREATED_AT,CREATED_BY,LAST_UPDATED_BY,LAST_UPDATED_AT,FLEX_COL1,FLEX_COL2,FLEX_COL3) values ('36','PoState',null,null,'已完成',null,null,null,null,'5',null,null);
Insert into OA.LOVS (ID,CODE,LOV_DESC,PARENT_CODE,VALUE,CREATED_AT,CREATED_BY,LAST_UPDATED_BY,LAST_UPDATED_AT,FLEX_COL1,FLEX_COL2,FLEX_COL3) values ('37','PoState',null,null,'已撤消',null,null,null,null,'6',null,null);
REM INSERTING into OA.MENUS
Insert into OA.MENUS (MENU_ID,MENU_NAME,MENU_TASKFLOW_URL,MENU_DESC,MENU_CATEGORY,PARENT_MENU_ID,MENU_MASTER_CATEGORY,MENU_ICON_URL) values ('SYS_PUR_MY_PR','我的采购申请','/WEB-INF/flows/welcome/welcome-btf.xml#welcome-btf','我的采购申请','PUR',null,'SYS','/images/icons/user.png');
...
Insert into OA.NOTIFICATIONS (ID,CATEGORY,PRIORITY,TITLE,CONTENT,TO_ROLE_ID,EVENT_DATE,IS_SMS_SENT,STATE) values ('1','test',1,'您有新的车辆审核','需要你审核以下车辆申请','1',to_date('07-FEB-13','DD-MON-RR'),'N',null);
