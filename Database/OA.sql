...
--------------------------------------------------------
  ...
  "CURRENT_VERIFIER" VARCHAR2(20 BYTE)
   ) ;
--------------------------------------------------------
...
Insert into OA.ITEM_CATEGORY_APPROVAL (ITEM_CATEGORY,APPROVAL_LIMIT) values ('IC_1',200);
Insert into OA.ITEM_CATEGORY_APPROVAL (ITEM_CATEGORY,APPROVAL_LIMIT) values ('IC_2',500);
Insert into OA.ITEM_CATEGORY_APPROVAL (ITEM_CATEGORY,APPROVAL_LIMIT) values ('IC_3',50);
...
Insert into OA.LOVS (ID,CODE,LOV_DESC,PARENT_CODE,VALUE,CREATED_AT,CREATED_BY,LAST_UPDATED_BY,LAST_UPDATED_AT,FLEX_COL1,FLEX_COL2,FLEX_COL3,EXPIRED) values ('45','ItemCatg',null,null,'计算机设备',null,null,null,null,'IC_1',null,null,'N');
Insert into OA.LOVS (ID,CODE,LOV_DESC,PARENT_CODE,VALUE,CREATED_AT,CREATED_BY,LAST_UPDATED_BY,LAST_UPDATED_AT,FLEX_COL1,FLEX_COL2,FLEX_COL3,EXPIRED) values ('46','ItemCatg',null,null,'办公设备',null,null,null,null,'IC_2',null,null,'N');
Insert into OA.LOVS (ID,CODE,LOV_DESC,PARENT_CODE,VALUE,CREATED_AT,CREATED_BY,LAST_UPDATED_BY,LAST_UPDATED_AT,FLEX_COL1,FLEX_COL2,FLEX_COL3,EXPIRED) values ('81','ItemCatg',null,null,'水果点心',null,null,null,null,'IC_3',null,null,'N');
Insert into OA.LOVS (ID,CODE,LOV_DESC,PARENT_CODE,VALUE,CREATED_AT,CREATED_BY,LAST_UPDATED_BY,LAST_UPDATED_AT,FLEX_COL1,FLEX_COL2,FLEX_COL3,EXPIRED) values ('47','Item',null,'IC_1','笔记本电脑',null,null,null,null,'I_1',null,null,'N');
Insert into OA.LOVS (ID,CODE,LOV_DESC,PARENT_CODE,VALUE,CREATED_AT,CREATED_BY,LAST_UPDATED_BY,LAST_UPDATED_AT,FLEX_COL1,FLEX_COL2,FLEX_COL3,EXPIRED) values ('48','Item',null,'IC_1','鼠标',null,null,null,null,'I_2',null,null,'N');
Insert into OA.LOVS (ID,CODE,LOV_DESC,PARENT_CODE,VALUE,CREATED_AT,CREATED_BY,LAST_UPDATED_BY,LAST_UPDATED_AT,FLEX_COL1,FLEX_COL2,FLEX_COL3,EXPIRED) values ('49','Item',null,'IC_1','移动硬盘',null,null,null,null,'I_3',null,null,'N');
Insert into OA.LOVS (ID,CODE,LOV_DESC,PARENT_CODE,VALUE,CREATED_AT,CREATED_BY,LAST_UPDATED_BY,LAST_UPDATED_AT,FLEX_COL1,FLEX_COL2,FLEX_COL3,EXPIRED) values ('50','Item',null,'IC_2','钢笔',null,null,null,null,'I_4',null,null,'N');
Insert into OA.LOVS (ID,CODE,LOV_DESC,PARENT_CODE,VALUE,CREATED_AT,CREATED_BY,LAST_UPDATED_BY,LAST_UPDATED_AT,FLEX_COL1,FLEX_COL2,FLEX_COL3,EXPIRED) values ('51','Item',null,'IC_2','圆珠笔',null,null,null,null,'I_5',null,null,'N');
Insert into OA.LOVS (ID,CODE,LOV_DESC,PARENT_CODE,VALUE,CREATED_AT,CREATED_BY,LAST_UPDATED_BY,LAST_UPDATED_AT,FLEX_COL1,FLEX_COL2,FLEX_COL3,EXPIRED) values ('52','Item',null,'IC_2','铅笔',null,null,null,null,'I_6',null,null,'N');
Insert into OA.LOVS (ID,CODE,LOV_DESC,PARENT_CODE,VALUE,CREATED_AT,CREATED_BY,LAST_UPDATED_BY,LAST_UPDATED_AT,FLEX_COL1,FLEX_COL2,FLEX_COL3,EXPIRED) values ('82','Item',null,'IC_3','水果',null,null,null,null,'I_7',null,null,'N');
Insert into OA.LOVS (ID,CODE,LOV_DESC,PARENT_CODE,VALUE,CREATED_AT,CREATED_BY,LAST_UPDATED_BY,LAST_UPDATED_AT,FLEX_COL1,FLEX_COL2,FLEX_COL3,EXPIRED) values ('83','Item',null,'IC_3','点心',null,null,null,null,'I_8',null,null,'N');
