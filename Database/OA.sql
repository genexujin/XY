...
Insert into OA.MENUS (MENU_ID,MENU_NAME,MENU_TASKFLOW_URL,MENU_DESC,MENU_CATEGORY,PARENT_MENU_ID,MENU_MASTER_CATEGORY,MENU_ICON_URL,EXPIRED,SEQ) values ('ADMIN_SMS','SMS管理','/WEB-INF/flows/admin/sms-enable-btf.xml#sms-enable-btf','SMS管理','SMS',null,'ADMIN',null,'false','9');
