...
// ---    Sat Jan 19 14:03:23 CST 2013
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class ClassroomCalendarViewImpl extends ViewObjectImpl implements ClassroomCalendarView {
    /**
     * This is the default constructor (do not remove).
     */
    public ClassroomCalendarViewImpl() {
    }
    
    public void newRow(){
        Row createRow = this.createRow();
        this.insertRowAtRangeIndex(0, createRow);
    ...
    public void refreshCalendar(String clsRmNos){
        ...
        for(Row row:allRowsInRange ){
            if(row.getAttribute("Classroom")==null){
                row.removeFromCollection();
                //row.remove();
                System.err.println("remove an empty row!");   
            }
        }
